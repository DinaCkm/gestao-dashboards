...
export const PROGRAMA_INTEGRACAO_CATALOG: Record<string, IntegracaoFormCatalog> = {
  "controle-integracao": {
    ...
    description:"Cadastro do novo colaborador, preenchido pela UGP.", targetRole:"UGP",
  ...
  "pesquisa-integracao": {
    ...
    description:"Respondida pelo colaborador depois de cada alinhamento.", targetRole:"Colaborador",
  ...
  "avaliacao-programa": {
    ...
    description:"Respondida pelo gestor e pelo Anjo depois de cada alinhamento.", targetRole:"Gestor / Anjo",
  ...
  "acompanhamento-pdi": {
    ...
    description:"Preenchido pela CKM e enviado à UGP no 45º e no 150º dia.", targetRole:"CKM",
