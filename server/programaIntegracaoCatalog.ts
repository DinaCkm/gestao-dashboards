...
export const PROGRAMA_INTEGRACAO_CATALOG: Record<string, IntegracaoFormCatalog> = {
  "controle-integracao": {
    key:"controle", slug:"controle-integracao", name:"Controle do Programa de Integração",
    description:"Cadastro do novo colaborador, preenchido pela UGP. Registrar aqui já marca o cadastro como preenchido — e completa os dados do processo.", targetRole:"UGP",
  ...
  "bem-acolhido": {
    key:"bem", slug:"bem-acolhido", name:"Bem Acolhido em Nossa Unidade",
    description:"Preparação da chegada, respondida pelo gestor. Traz o Anjo escolhido e o que foi planejado para os primeiros 15 e 60 dias.", targetRole:"Gestor",
    ...
    outro:["Gestor(a),","Parabéns por concluir o preenchimento do formulário! Suas respostas serão enviadas para a empresa responsável pela avaliação de perfil, para o Núcleo de Desenvolvimento - UGP e também serão documentadas no processo do Programa de Integração.","Agora, vamos avançar juntos para a próxima etapa: preparar uma recepção calorosa para o novo colaborador. Já pensou em todos os detalhes para recebê-lo na sua unidade? Lembre-se de alguns itens que farão toda a diferença:","1. Comunique aos demais membros da equipe sobre a chegada do novo colaborador, para que todos possam se preparar e dar as boas-vindas ao novo parceiro de trabalho.","2. Providencie tudo o que é necessário para o trabalho, desde a cadeira até o computador. É importante garantir que ele tenha um espaço adequado para se sentir confortável e produtivo.","3. Configure a conta de e-mail e forneça os acessos aos softwares necessários para que ele possa executar suas atividades. Isso demonstra cuidado e acolhimento logo no início.","4. Que tal preparar um informativo impresso com informações importantes, como o número de telefone para contato no Sebrae/TO, ramais, nome da área e outros dados? Assim, o novo colaborador terá à mão todas as informações necessárias e se sentirá mais seguro.","Além disso, lembre-se de que pequenos gestos, como lembrancinhas ou bilhetes de boas-vindas, são sempre bem recebidos e contribuem para criar um ambiente acolhedor.","A recepção é uma oportunidade única de demonstrar a cultura da empresa e integrar o novo colaborador à equipe. Tenho certeza de que, com essas dicas, você irá proporcionar uma experiência incrível para ele.","Se surgir alguma dúvida ou se precisar de apoio, conte conosco. Estamos aqui para garantir que a recepção do novo colaborador seja memorável e o ajude a se sentir parte da equipe desde o primeiro dia.","Juntos, construiremos um ambiente de trabalho acolhedor e produtivo.","Um abraço!","CKM Talents e Núcleo de Desenvolvimento - UGP SEBRAE Tocantins"],
    ...
    sections:[
      ...
      {title:"Perfil",intro:"Os dados aqui selecionados pautarão a avaliação do novo contrato.",questions:[{code:"bem_caracteristicas",label:"Dentre as palavras abaixo, assinale TODAS as palavras que representam como colaborador deve atuar na sua unidade:",type:"multi",required:true,options:QUALIDADES_BEM}]},
      {title:"Conhecimentos",intro:"Neste item aqui, a gente vai precisar da sua ajuda para descrever algumas informações importantes para um período de 6 meses. Esses detalhes vão ser a base para construir o Plano de Desenvolvimento do novo contratado.\\n\\nEsse plano vai direcionar o crescimento e o progresso do nosso novo membro da equipe nos próximos meses. Queremos garantir que ele tenha todas as oportunidades para se desenvolver e se destacar aqui no Sebrae/TO.\\n\\nEntão, quando for preencher essas informações, pense bem e descreva tudo de maneira clara. É uma chance incrível de fazer a diferença na trajetória profissional dessa pessoa.",questions:[
      ...
      {title:"Planejamento de atividades/demandas",intro:"Chegamos à reta final e precisamos da sua colaboração para planejar as atividades do novo contratado nos primeiros 15 e 30 dias. É super importante considerar o processo de desenvolvimento dele ao elaborar esse planejamento.\\n\\nAh, não esqueça de reservar um tempinho para a aprendizagem. É fundamental proporcionar momentos de aprendizado para que o recém-contratado possa se familiarizar com a empresa e se adaptar ao novo ambiente de trabalho.\\n\\nLembre-se também de que esse preenchimento será a base para fornecer feedbacks nos períodos de 15 e 30 dias. Essas avaliações são essenciais para acompanhar o progresso do colaborador durante o período de experiência.\\n\\nVamos, lá!",questions:[
        ...
        text("bem_primeiros_60_dias","Primeiros 60 dias: Descreva as tarefas, demandas e entregas planejadas para os primeiros 60 dias do recém-contratado, incluindo as atividades que ele deverá desenvolver, acompanhar ou começar a assumir com maior autonomia ao longo desse período."),
      ]},
    ],
  },
  "pesquisa-integracao": {
    key:"pesquisa", slug:"pesquisa-integracao", name:"Pesquisa de Integração",
    description:"Respondida pelo colaborador depois de cada alinhamento. O período informado define a qual ciclo a resposta pertence.", targetRole:"Colaborador",
    ...
    cycleOptions:[
      {value:"15",cycle:1,label:"15º dia (Minha primeira resposta)"},{value:"45",cycle:2,label:"45º dia"},
  ...
  "avaliacao-programa": {
    key:"aval", slug:"avaliacao-programa", name:"Avaliação do Programa de Integração",
    description:"Respondida pelo gestor e pelo Anjo depois de cada alinhamento. É o formulário que libera o relatório de evolução dos e-mails de agendamento.", targetRole:"Gestor / Anjo",
    ...
    sections:[
      ...
      {title:"Conceitos e devolutiva",intro:"De maneira geral, como o novo colaborador pode ser classificado (veja a explicação logo abaixo de cada pergunta):",questions:[
  ...
  "acompanhamento-pdi": {
    key:"pdi", slug:"acompanhamento-pdi", name:"Acompanhamento do PDI",
    description:"Preenchido pela CKM e enviado à UGP no 45º e no 150º dia. Atualiza o status do PDI e da Jornada Compliance usados nos e-mails.", targetRole:"CKM",
