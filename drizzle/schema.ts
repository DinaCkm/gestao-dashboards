...
export const turmas = mysqlTable("turmas", {
  ...
  isActive: int("isActive").default(1).notNull(),
  codigoTurma: varchar("codigoTurma", { length: 20 }), // Código da turma (ex: BS1, BS2, BS3). Agrupa trilhas da mesma turma para congelamento conjunto.
...
export const assessmentPdi = mysqlTable("assessment_pdi", {
  ...
  status: mysqlEnum("status", ["ativo", "congelado", "encerrado"]).default("ativo").notNull(),
  observacoes: text("observacoes"),
...
export const departments = mysqlTable("departments", {
  ...
  name: varchar("name", { length: 255 }).notNull(),
  description: text("description"),
  managerId: int("managerId"), // Lider do departamento - referencia alunos.id (qualquer aluno/colaborador da empresa)
...
export const atividadesCurso = mysqlTable("atividades_curso", {
  ...
  titulo: varchar("titulo", { length: 255 }).notNull(),
  tipoAtividade: mysqlEnum("tipoAtividade", ["genially", "video", "podcast", "tedtalk", "livro", "intro", "pdf", "pagina"]).notNull(),
